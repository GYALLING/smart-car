...
/*
#define WIFI_SSID_TEST          "AHPU "
#define WIFI_PASSWORD_TEST      "NULL"
#define TCP_TARGET_IP           "10.5.57.76"             // 连接目标的 IP
...
#define WIFI_SSID_TEST          "74479313"
...
*/
    ...
    while (TRUE)
    {
        ...
        /*       // 这里仅写入4个通道数据
               seekfree_assistant_oscilloscope_data.data[0] = speedc;
